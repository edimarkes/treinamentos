            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="text-container">
                        ...
                        <p class="p-large p-heading">Aprenda a desenvolver raciocínio lógico para a resolução computacional de problemas.</p>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="image-container">
                        <img class="img-fluid" src="cursosgerais/images/logica.jpg" alt="Lógica de Programação">
                    </div> <!-- end of text-container -->
                </div> <!-- end of col -->
            </div> <!-- end of row -->
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <b class="card-title">Reconhecer e identificar padrões</b>
                        </div>
                    </div>
                    <!-- end of card -->
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <b class="card-title">Resolver problemas de forma lógica</b>
                        </div>
                    </div>
                    <!-- end of card -->
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <b class="card-title">Automatizar tarefas </b>
                        </div>
                    </div>
                    <!-- end of card -->
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <b class="card-title">Entender as tecnologias e linguagens atuais</b>
                        </div>
                    </div>
                    <!-- end of card -->
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <b class="card-title">Organizar processos</b>
                        </div>
                    </div>
                    <!-- end of card -->
    ...
    <div id="description" class="basic-1">
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
                    <div class="image-container">
                        <img class="img-fluid" src="cursosgerais/images/logica2.png" alt="Lógica de Programação">
                    ...
                    <div class="proximasturmas">
                        ...
                        <table>
                            ...
                            <tbody>
                                ...
                                @if($curso->site == 1)
                                @if($curso->nomecurso == 'Lógica de Progamação' && $curso->periodo == 'Noturno' && $curso->diassemana == "Segundas, Quartas e Sextas" && $curso->formato == 'Online ao Vivo')
                        ...
                        <table>
                            ...
                            <tbody>
                                ...
                                @foreach($cursosevento as $curso)
                                @if($curso->site == 1)
                                @if($curso->nomecurso == 'Lógica de Progamação' && $curso->periodo == 'Noturno' && $curso->diassemana == 'Terças e Quintas' && $curso->formato == 'Online ao Vivo')
                                <tr>
                        ...
                        <table>
                            ...
                            <tbody>
                                ...
                                @foreach($cursosevento as $curso)
                                @if($curso->site == 1)
                                @if($curso->nomecurso == 'Lógica de Progamação' && $curso->periodo == 'Sábados' && $curso->diassemana == 'Sábados Manhã' && $curso->formato == 'Online ao Vivo')
                                <tr>
                        ...
                        <table>
                            ...
                            <tbody>
                                ...
                                @foreach($cursosevento as $curso)
                                @if($curso->site == 1)
                                @if($curso->nomecurso == 'Lógica de Progamação' && $curso->periodo == 'Sábados' && $curso->diassemana == 'Sábados Tarde' && $curso->formato == 'Online ao Vivo')
                                <tr>
                    ...
                    <div class="proximasturmasonline">
                        ...
                        <table>
                            ...
                            <tbody>
                                ...
                                @foreach($cursosevento as $curso)
                                @if($curso->site == 1)
                                @if($curso->nomecurso == 'Lógica de Progamação' && $curso->periodo == 'Noturno' && $curso->diassemana == "Segundas, Quartas e Sextas" && $curso->formato == 'Presencial')
                        ...
                        <table>
                            ...
                            <tbody>
                                ...
                                @foreach($cursosevento as $curso)
                                @if($curso->site == 1)
                                @if($curso->nomecurso == 'Lógica de Progamação' && $curso->periodo == 'Noturno' && $curso->diassemana == 'Terças e Quintas' && $curso->formato == 'Presencial')
                                <tr>
                        ...
                        <table>
                            ...
                            <tbody>
                                ...
                                @foreach($cursosevento as $curso)
                                @if($curso->site == 1)
                                @if($curso->nomecurso == 'Lógica de Progamação' && $curso->periodo == 'Sábados' && $curso->diassemana == 'Sábados Manhã' && $curso->formato == 'Presencial')
                                <tr>
                        ...
                        <table>
                            ...
                            <tbody>
                                ...
                                @foreach($cursosevento as $curso)
                                @if($curso->site == 1)
                                @if($curso->nomecurso == 'Lógica de Progamação' && $curso->periodo == 'Sábados' && $curso->diassemana == 'Sábados Tarde' && $curso->formato == 'Presencial')
                                <tr>
