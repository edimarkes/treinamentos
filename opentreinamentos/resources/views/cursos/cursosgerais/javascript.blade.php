            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="text-container">
                        <h1>JavaScript</h1>
                        <p class="p-large p-heading">Aprenda uma das principais linguagens no desenvolvimento web.</p>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="image-container">
                        <img class="img-fluid" src="cursosgerais/images/javascript1.jpg" alt="JavaScript">
                    </div> <!-- end of text-container -->
                </div> <!-- end of col -->
            </div> <!-- end of row -->
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <b class="card-title">Booleanos</b>
                        </div>
                    </div>
                    <!-- end of card -->
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <b class="card-title">Condicionais</b>
                        </div>
                    </div>
                    <!-- end of card -->
    ...
    <div id="description" class="basic-1">
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
                    <div class="image-container">
                        <img class="img-fluid" src="cursosgerais/images/javascript2.jpg" alt="Javascript">
                ...
                <div class="col-lg-6">
                    <div class="text-container">
                        <h3>Sobre o Curso</h3>
                        <p>Descubra os conceitos básicos do JavaScripta e comece a aprender essa que é uma das principais linguagens no desenvolvento web frontend.</p>
                        <ul class="list-unstyled li-space-lg">
                            <li class="media">
                                <i class="fas fa-square"></i>
                                <div class="media-body">Destaque-se por causa dos seus conhecimentos de JavaScript.
                            </li>
                            <li class="media">
                                <i class="fas fa-square"></i>
                                <div class="media-body">Inicie orientação a objestos em JavaScript.</div>
                            </li>
                            <li class="media">
                                <i class="fas fa-square"></i>
                                <div class="media-body">Conheça as principais novidades do ES6.</div>
                            </li>
                        </ul>
                    ...
                    <div class="proximasturmas">
                        ...
                        <table>
                            ...
                            <tbody>
                                ...
                                @if($curso->site == 1)
                                @if($curso->nomecurso == 'javaScript' && $curso->periodo == 'Noturno' && $curso->diassemana == "Segundas, Quartas e Sextas" && $curso->formato == 'Online ao Vivo')
                        ...
                        <table>
                            ...
                            <tbody>
                                ...
                                @foreach($cursosevento as $curso)
                                @if($curso->site == 1)
                                @if($curso->nomecurso == 'javaScript' && $curso->periodo == 'Noturno' && $curso->diassemana == 'Terças e Quintas' && $curso->formato == 'Online ao Vivo')
                                <tr>
                        ...
                        <table>
                            ...
                            <tbody>
                                ...
                                @foreach($cursosevento as $curso)
                                @if($curso->site == 1)
                                @if($curso->nomecurso == 'javaScript' && $curso->periodo == 'Sábados' && $curso->diassemana == 'Sábados Manhã' && $curso->formato == 'Online ao Vivo')
                                <tr>
                        ...
                        <table>
                            ...
                            <tbody>
                                ...
                                @foreach($cursosevento as $curso)
                                @if($curso->site == 1)
                                @if($curso->nomecurso == 'javaScript' && $curso->periodo == 'Sábados' && $curso->diassemana == 'Sábados Tarde' && $curso->formato == 'Online ao Vivo')
                                <tr>
                    ...
                    <div class="proximasturmasonline">
                        ...
                        <table>
                            ...
                            <tbody>
                                ...
                                @foreach($cursosevento as $curso)
                                @if($curso->site == 1)
                                @if($curso->nomecurso == 'javaScript' && $curso->periodo == 'Noturno' && $curso->diassemana == "Segundas, Quartas e Sextas" && $curso->formato == 'Presencial')
                        ...
                        <table>
                            ...
                            <tbody>
                                ...
                                @foreach($cursosevento as $curso)
                                @if($curso->site == 1)
                                @if($curso->nomecurso == 'javaScript' && $curso->periodo == 'Noturno' && $curso->diassemana == 'Terças e Quintas' && $curso->formato == 'Presencial')
                                <tr>
                        ...
                        <table>
                            ...
                            <tbody>
                                ...
                                @foreach($cursosevento as $curso)
                                @if($curso->site == 1)
                                @if($curso->nomecurso == 'javaScript' && $curso->periodo == 'Sábados' && $curso->diassemana == 'Sábados Manhã' && $curso->formato == 'Presencial')
                                <tr>
                        ...
                        <table>
                            ...
                            <tbody>
                                ...
                                @foreach($cursosevento as $curso)
                                @if($curso->site == 1)
                                @if($curso->nomecurso == 'javaScript' && $curso->periodo == 'Sábados' && $curso->diassemana == 'Sábados Tarde' && $curso->formato == 'Presencial')
                                <tr>
