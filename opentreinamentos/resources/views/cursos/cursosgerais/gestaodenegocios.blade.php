...
@section('title','Gestão de Negócios')
@section('content')
<!-- Webpage Title -->
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="text-container">
                        ...
                        <p class="p-large p-heading">Aprenda a criar soluções flexíveis, extensíveis e testáveis com a linguagem C#.</p>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="image-container">
                        <img class="img-fluid" src="cursosgerais/images/csharp1.png" alt="alternative">
                    </div> <!-- end of text-container -->
                </div> <!-- end of col -->
            </div> <!-- end of row -->
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <b class="card-title">Atributos</b>
                        </div>
                    </div>
                    <!-- end of card -->
    ...
    <div id="description" class="basic-1">
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
                    <div class="image-container">
                        <img class="img-fluid" src="cursosgerais/images/csharp2.png" alt="alternative">
                ...
                <div class="col-lg-6">
                    <div class="text-container">
                        <h3>Sobre o Curso</h3>
                        <p>Domine a programação Orientada a Objetos e linguagem C#.</p>
                        <ul class="list-unstyled li-space-lg">
                            <li class="media">
                                <i class="fas fa-square"></i>
                                <div class="media-body">Destaque-se por causa dos seus conhecimentos de C#.
                            </li>
                            <li class="media">
                                <i class="fas fa-square"></i>
                            ...
                            <li class="media">
                                <i class="fas fa-square"></i>
                                <div class="media-body">Aplique o conhecimento de orientação a objetos na construção de soluções para problemas reais.</div>
                            </li>
                        </ul>
                    ...
                    <div class="proximasturmas">
                        ...
                        <table>
                            ...
                            <tbody>
                                ...
                                @if($curso->site == 1)
                                @if($curso->nomecurso == 'Gestão de Negócios' && $curso->periodo == 'Noturno' && $curso->diassemana == "Segundas, Quartas e Sextas" && $curso->formato == 'Online ao Vivo')
                                ...
                                <tr>
                                    ...
                                    <td><a href="/eventos/{{$curso->id}}"><ion-icon name="cart-outline" class="cartoutline"></ion-icon></a>
                                    </td>
                                    @endif
                                    @endif
                                </tr>
                        ...
                        <table>
                            ...
                            <tbody>
                                ...
                                @foreach($cursosevento as $curso)
                                @if($curso->site == 1)
                                @if($curso->nomecurso == 'Gestão de Negócios' && $curso->periodo == 'Noturno' && $curso->diassemana == 'Terças e Quintas' && $curso->formato == 'Online ao Vivo')
                                <tr>
                        ...
                        <table>
                            ...
                            <tbody>
                                ...
                                @foreach($cursosevento as $curso)
                                @if($curso->site == 1)
                                @if($curso->nomecurso == 'Gestão de Negócios' && $curso->periodo == 'Sábados' && $curso->diassemana == 'Sábados Manhã' && $curso->formato == 'Online ao Vivo')
                                <tr>
                        ...
                        <table>
                            ...
                            <tbody>
                                ...
                                @foreach($cursosevento as $curso)
                                @if($curso->site == 1)
                                @if($curso->nomecurso == 'Gestão de Negócios' && $curso->periodo == 'Sábados' && $curso->diassemana == 'Sábados Tarde' && $curso->formato == 'Online ao Vivo')
                                <tr>
                    ...
                    <div class="proximasturmasonline">
                        ...
                        <table>
                            ...
                            <tbody>
                                ...
                                @foreach($cursosevento as $curso)
                                @if($curso->site == 1)
                                @if($curso->nomecurso == 'Gestão de Negócios' && $curso->periodo == 'Noturno' && $curso->diassemana == "Segundas, Quartas e Sextas" && $curso->formato == 'Presencial')
                        ...
                        <table>
                            ...
                            <tbody>
                                ...
                                @foreach($cursosevento as $curso)
                                @if($curso->site == 1)
                                @if($curso->nomecurso == 'Gestão de Negócios' && $curso->periodo == 'Noturno' && $curso->diassemana == 'Terças e Quintas' && $curso->formato == 'Presencial')
                                <tr>
                        ...
                        <table>
                            ...
                            <tbody>
                                ...
                                @foreach($cursosevento as $curso)
                                @if($curso->site == 1)
                                @if($curso->nomecurso == 'Gestão de Negócios' && $curso->periodo == 'Sábados' && $curso->diassemana == 'Sábados Manhã' && $curso->formato == 'Presencial')
                                <tr>
                        ...
                        <table>
                            ...
                            <tbody>
                                ...
                                @foreach($cursosevento as $curso)
                                @if($curso->site == 1)
                                @if($curso->nomecurso == 'Gestão de Negócios' && $curso->periodo == 'Sábados' && $curso->diassemana == 'Sábados Tarde' && $curso->formato == 'Presencial')
                                <tr>
                ...
                <div class="col-lg-6 cursorelacionado">
                    <div class="text-cursosrelacionados">
                        <div class="toprelacionados">
                            ...
                            <ul class="list-unstyled li-space-lg">
                                <li class="media">
                                    <p><img src="/cursosgerais/images/frontend2.png" alt="logica de programacao" class="imagemrelacionados"></p>
                                </li>
